...
if(isset($_POST['insert_product'])){
    ...
    $available_services=$_POST['available_services'];
    ...
    //acssing image tmp name
    $temp_image1=$_FILES['product_image1']['tmp_name'];
    $temp_image2=$_FILES['product_image2']['tmp_name'];
    $temp_image3=$_FILES['product_image3']['tmp_name'];
    //checking empty condition
    if($product_title=='' or $description=='' or  $available_services=='' or  $product_keywords=='' or
    $product_category=='' or  $product_brands=='' or$product_price=='' or $product_image1=='' or
     $product_image2=='' or $product_image3=='' ){
        ...
        //insert query
        $insert_products="insert into `products` (product_title,product_description,available_services,product_keyword,
        category_id,brand_id,product_image1,product_image2,product_image3,product_price,date,status) 
        values('$product_title','$description','$available_services','$product_keywords',
...
<head>
    ...
    <title>Insert Products- Admin(TAILOR) Dashboard</title>
     <!-----------Bootstrap CSS link-->
...
<body class="bg-light">
    <div class="container mt-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <!--Available services by tailors-->
            <div class="form-outline mb-4 w-50 m-auto">
                <label for="available_services" class="form-label">Available Services</label>
                <input type="text" name="available_services" id="available_services" 
                class="form-control" placeholder="Enter Available_services"
                 autocomplete="off" required="required">
            </div>
            <!--keywords-->
            <div class="form-outline mb-4 w-50 m-auto">
